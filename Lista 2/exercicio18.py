...
def mes_com_menos_vendas(caminho_arquivo):
    try:
...
mes_com_menos_venda = mes_com_menos_vendas(caminho_do_arquivo_csv)

if mes_com_menos_venda:
    print(f"O mês com menos vendas é: {mes_com_menos_venda}")
